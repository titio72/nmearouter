...
public class NMEA0183HDMMessage extends NMEA0183Message implements MsgHeading {

    public NMEA0183HDMMessage(@NotNull HDMSentence sentence) {
        super(sentence);
    }
    ...
    public double getHeading() {
        try {
            return ((HDMSentence)getSentence()).getHeading();
