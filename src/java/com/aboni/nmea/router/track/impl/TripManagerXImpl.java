...
public class TripManagerXImpl implements TripManagerX {
    ...
    @Inject
    public TripManagerXImpl(@Named("TripTableName") String tripTableName,
                            @Named("TrackTableName") String trackTableName,
                            @Named("TrackEventWriter") DBEventWriter trackEventWriter,
                            @Named("TripEventWriter") DBEventWriter tripEventWriter) {
