...
public class NMEAPowerDBTargetInflux extends NMEAAgentImpl {
    ...
    @Inject
    public NMEAPowerDBTargetInflux(@NotNull Log log, @NotNull TimestampProvider tp,
                                   @NotNull @Named(Constants.TAG_POWER_INFLUX) StatsWriter w) {
