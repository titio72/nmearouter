...
import com.aboni.nmea.router.n2k.canboat.CANBOATLightParser;
...
public class CANBOATStreamImpl implements CANBOATStream {
    ...
    public CANBOATPGNMessage getMessage(String sMessage) {
        try {
            CANBOATLightParser p = new CANBOATLightParser(sMessage);
            int pgn = p.getPgn();
