...
public class NMEARouterModule extends AbstractModule {
	...
	protected void configure() {
        ...
        bind(DBEventWriter.class).annotatedWith(Names.named("TrackEventWriter")).to(DBTrackEventWriter.class);
        bind(DBEventWriter.class).annotatedWith(Names.named("TripEventWriter")).to(DBTripEventWriter.class);
